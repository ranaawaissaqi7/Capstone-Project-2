                        ...
                        isAuthChange ? <>
                                                    ...
                                                    <form>
                                                        <div className="row">
                                                            <div className="col-md-6">
                                                                ...
                                                                <input type="text" className="form-control" name='fname' id="FirstName" placeholder="Isabella" onChange={onChangeHandler} />
                                                            ...
                                                            <div className="col-md-6">
                                                                ...
                                                                <input type="email" className="form-control" name='lname' id="LastName" placeholder="Bocouse" onChange={onChangeHandler} />
                                                        ...
                                                        <div className="row">
                                                            <div className="col-md-6">
                                                                ...
                                                                <input type="email" className="form-control" name='email' id="inputEmail4" placeholder="bocouse@example.com" onChange={onChangeHandler} />
                                                            ...
                                                            <div className="col-md-6">
                                                                ...
                                                                <input type="number" className="form-control" name='phoneNo' id="phone" placeholder='+1' onChange={onChangeHandler} />
                                                        ...
                                                        <div className="row">
                                                            <div className="col-md-12">
                                                                ...
                                                                <textarea class="form-control" name='bio' id="exampleFormControlTextarea1" rows="3" placeholder="Add Bio..." onChange={onChangeHandler}></textarea>
                            ...
                            <div className="row vh-100 align-items-center ">
                                ...
                                <div className="col-md-8">
                                    <h1 className='text-center text-danger' >User is Not Login <Link className='btn btn-outline-success' to={"/login"} >Click to Login </Link> </h1>
                                </div>
                            </div>
